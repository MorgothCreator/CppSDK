...
GI::Dev::St7565::St7565(LCD_TIMINGS *timings, char *spiPath)
{
    ...
    drawVLine_Ptr = &GI::Dev::St7565::_drawVLine;
    clear_Ptr = &GI::Dev::St7565::_clear;
    refresh_Ptr = &GI::Dev::St7565::_refresh;
    sClipRegion.sXMin = 0;
    sClipRegion.sYMin = 0;
...
GI::Dev::St7565::~St7565()
{

}

void GI::Dev::St7565::reset()
{
    RESET->setOut(0);
...
void GI::Dev::St7565::wrCmd(unsigned char cmd)
{
    CD->setOut(0);
    spiDevice->writeBytes(&cmd, 1);
}

void GI::Dev::St7565::_refresh(void *driverHandlerPtr)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
...
void GI::Dev::St7565::_setOn(void *driverHandlerPtr)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
    driverHandler->wrCmd(0xAF);
}

void GI::Dev::St7565::_setOff(void *driverHandlerPtr)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
    driverHandler->wrCmd(0xAE);
}

bool GI::Dev::St7565::_setOrientation(void *driverHandlerPtr, LCD_ORIENTATION orientation)
{
    //GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
    return false;
}

void GI::Dev::St7565::_cacheClean(void *driverHandlerPtr, signed int x_start, signed int y_start, signed int x_len, signed int y_len)
{

}

void GI::Dev::St7565::_drawPixel(void *driverHandlerPtr, signed int X_Coordonate, signed int Y_Coordonate, unsigned int color)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
...
void GI::Dev::St7565::_drawRectangle(void *driverHandlerPtr, signed int x_start, signed int y_start, signed int x_len, signed int y_len, bool fill, unsigned int color)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
...
void GI::Dev::St7565::_drawHLine(void *driverHandlerPtr, signed int X1, signed int X2, signed int Y, unsigned char width, unsigned int color)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
...
void GI::Dev::St7565::_drawVLine(void *driverHandlerPtr, signed int Y1, signed int Y2, signed int X, unsigned char width, unsigned int color)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
...
void GI::Dev::St7565::_clear(void *driverHandlerPtr, unsigned int color)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
    _drawRectangle(driverHandlerPtr, 0, 0, driverHandler->LcdTimings->X, driverHandler->LcdTimings->Y, 1, color);
}

void GI::Dev::St7565::_setLuminosity(void *driverHandlerPtr, unsigned char luminosity)
{
    GI::Dev::St7565 *driverHandler = (GI::Dev::St7565 *)driverHandlerPtr;
    /* Contrast control */
