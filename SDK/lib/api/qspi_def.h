...
typedef struct n25qxxx_s
{
	...
	unsigned char (*read)(Qspi_Mem_t *param, unsigned char* pData,
			unsigned long ReadAddr, unsigned long Size);
	unsigned char (*write)(Qspi_Mem_t *param, unsigned char* pData,
			unsigned long WriteAddr, unsigned long Size);
	unsigned int (*read_block)(void *param, void* pData, unsigned long block,
			unsigned int nblks);
	unsigned int (*write_block)(void *param, void* pData, unsigned long block,
			unsigned int nblks);
	unsigned char (*flush_block)(void *param);
	void (*ioctl_block)(void *param, unsigned int command,
			unsigned int *buffer);
