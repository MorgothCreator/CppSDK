...
{/*sck, mosi, miso, cs*/
	...
	{ "hbtn-0"		,pin_mux_convert_to_pin(IOA,  0)	,false	,CfgGpio::GPIO_IN_FLOATING		, false },// Pin 2 mapped
	...
	{ "touchirq"	,pin_mux_convert_to_pin(IOJ,  5)	,false	,CfgGpio::GPIO_IN_FLOATING		, false },// Pin 5 mapped
	{ "mmcsdcd"		,pin_mux_convert_to_pin(IOG,  2)	,false	,CfgGpio::GPIO_IN_FLOATING		, false },// Pin 6 mapped
	{ ""			,0									,false	,CfgGpio::GPIO_IN_FLOATING		, false } // End of table
};
/*
 * !GPIO settings
 */
