...
unsigned char QSPI_N24Q_Read(Qspi_Mem_t *param, unsigned char* pData,
		unsigned long ReadAddr, unsigned long Size);
unsigned char QSPI_N24Q_Write(Qspi_Mem_t *param, unsigned char* pData,
		unsigned long WriteAddr, unsigned long Size);
unsigned char QSPI_N24Q_Erase_Block(Qspi_Mem_t *param,
